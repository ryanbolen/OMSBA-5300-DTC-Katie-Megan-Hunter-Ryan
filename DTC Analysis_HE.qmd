...
model_industry_comparison <- feols(unem_rate ~ post_covid * (wholesale_trade + information + finance_insurance_realestate + professional_scientific_management + educational_services_healthcare + arts_entertainment_recreation + other_services + manufacturing + agriculture_forestry_fishing_mining + military + public_administration + transportation_warehousing_utilities + construction), data = your_data_frame)
...
model3 <- feols(log(hhincome)~post_covid + female + age + educ_factor, data = main_data)
